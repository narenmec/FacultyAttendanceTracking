  ...
  return (
    <div className="bg-yellow-100 border-yellow-400 text-yellow-700 px-4 py-3 rounded-lg relative flex items-start mb-6 dark:bg-yellow-900/50 dark:border-yellow-700 dark:text-yellow-300" role="alert">
      ...
      <div>
        ...
        <p className="mt-1">
          The application cannot connect to the database. Please update your Firebase project configuration in the file: <code className="bg-yellow-200 text-yellow-900 text-sm p-1 rounded mx-1 dark:bg-yellow-800/50 dark:text-yellow-200">src/firebase/config.ts</code>
        </p>
      </div>
    </div>
  );

    ...
    <div className="max-w-2xl mx-auto space-y-8">
      <div className="bg-secondary p-8 rounded-lg shadow-xl dark:bg-gray-800">
        <div className="text-center mb-8">
          ...
          <h2 className="mt-4 text-2xl font-semibold text-text-primary dark:text-gray-100">Application Settings</h2>
          <p className="mt-2 text-text-secondary dark:text-gray-400">
            Adjust the core business logic of the application. Changes will be applied globally.
          </p>
        </div>
